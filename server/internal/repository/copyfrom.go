...
func (q *Queries) BatchCreateAccount(ctx context.Context, arg []BatchCreateAccountParams) (int64, error) {
	return q.db.CopyFrom(ctx, []string{"accounts"}, []string{"created_by", "name", "type", "balance", "currency", "color", "meta", "connection_id", "is_external", "provider_account_id", "provider_name"}, &iteratorForBatchCreateAccount{rows: arg})
}
