/**
 * Currency Schema - Local-First Database
 * 
 * Mirrors the backend PostgreSQL currencies table for local storage.
 * Contains currency codes and names for offline reference.
 */

import { sqliteTable, text } from 'drizzle-orm/sqlite-core';

export const currencies = sqliteTable('currencies', {
  code: text('code', { length: 3 }).primaryKey(), // 3-character currency code (USD, EUR, etc.)
...
// Default currencies data - mirrors backend seed data
export const defaultCurrencies: NewCurrency[] = [
